  ...
  return (
    ...
    <Navbar />
      {/*
        ...
        ```
      */}
      <div className="bg-gray-800 min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          <div>
            <a href="/">
			<img src="https://www.pointblank.id/images/bi_wide_new.png" alt="Point Blank beyond Limits"/>
		    </a>
          </div>
